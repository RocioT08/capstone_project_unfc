...
N_INSAMPLE_ORIGINS = 12      # in-sample forecast origins per window (train-set metrics)
PERF_FOLD_MEMORY   = 3       # OOF folds used for the assembly's recent-performance features
SEED        = 42
CONFIDENCE  = 0.95
OUT_DIR     = "results"
